...
.. code-block:: terraform
    ...
    module "minio_storage_runtime" {
      source       = "git::https://github.com/nolte/terraform-infrastructure-modules.git//storage_elements?ref=v0.0.2.dev"
...
.. code-block:: terraform
    ...
    module "minio_computing_elements" {
      source                                           = "git::https://github.com/nolte/terraform-infrastructure-modules.git//computing_elements?ref=v0.0.2.dev"
